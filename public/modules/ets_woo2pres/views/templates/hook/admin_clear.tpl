        ...
        <div class="form-group">
             <div id="block_form_clear_message">
                    ...
                    {if !$message_error}
                        <div class="bootstrap">
                    		<div class="alert alert-success">
                                ...
                                {l s='History have been cleared successfully' mod='ets_woo2pres'}
                    		</div>
                    	</div>
                    {else}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <button class="btn btn-default" type="submit" id="submit_clear_history" name="submit_clear_history">{l s='Clear' mod='ets_woo2pres'}</button>
                    </div>
                </div>
