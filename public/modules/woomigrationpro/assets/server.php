...
define('MP_TOKEN', "c092ad819566df04d48a1eb7e5642312");
...
class MPServer
{
    ...
    function run()
    {
        ...
        if (!$this->_checkToken()) {
            $this->response->error('The connector module generated for local.test! Please, re-download connector module and install to the WooCommerce and try connection again.', null);
            return;
        }
