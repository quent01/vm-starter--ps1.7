...
class WooMigrationProDBWarningLogger extends ObjectModel
{
    const TYPE_TAX = 't';
    ...
    public static $definition = array(
        'table' => 'woomigrationpro_warning_logs',
        'primary' => 'id',
        'fields' => array(
    ...
    public static function addWarningLogToDB($logText, $entityType)
    {
        ...
        $sql = "INSERT INTO " . _DB_PREFIX_ . "woomigrationpro_warning_logs SET log_text='" . pSQL($logText) . "', entity_type = '" . pSQL($type) . "', log_date_add='" . date('Y-m-d h:i:s', time()) . "'";
    ...
    {
        $logFilePath = _PS_MODULE_DIR_ . 'woomigrationpro/classes/loggers/warning_logs.txt';
    ...
    {
        $sql = "SELECT entity_type, COUNT(*) as count FROM " . _DB_PREFIX_ . "woomigrationpro_warning_logs GROUP BY entity_type";
    ...
    {
        $sql = 'DELETE FROM ' . _DB_PREFIX_ . 'woomigrationpro_warning_logs';
